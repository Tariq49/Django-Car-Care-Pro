...
class MechanicDetails(admin.ModelAdmin):
    list_display = ('id','get_mechanic_name', 'years_of_experience','contact_number','preferred_job_types','formatted_work_days')
...
class MechanicService(admin.ModelAdmin):
    list_display = ('id','get_mechanic_name','service_name','formatted_hourly_rate')   
